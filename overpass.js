        ...
        $.get(overpassApiUrl, function (osmDataAsJson) {
          ...
          var resultLayer = L.geoJson(resultAsGeojson, {
            ...
            onEachFeature: function (feature, layer) {
              ...
              var codeAfter = "";
              var payments = "";
              var supportedPayment = {"payment:cash" : "Bargeld", "payment:ep_geldkarte" : "Geldkarte", "payment:maestro" : "Maestro", "payment:visa_electron" : "Visa Electron", "payment:visa_debit" : "Visa Debit", "payment:girocard" : "Girokarte oder EC", "payment:mastercard" : "Mastercard", "payment:visa" : "Visa", "payment:american_express" : "American Express", "payment:paypal" : "Paypal"};
              ...
              var phone_button = ((phone == "Unbekannt") ? "" : "<a class=\"specialbtn\" href=\"tel:" + phone + "\">Anrufen</a>");
              ...
              for (var payTag in supportedPayment) {
              	if (feature.properties.tags[payTag] != undefined) {
              		if (feature.properties.tags[payTag] == "yes" || feature.properties.tags[payTag] == "interval") {
              			if (payments == "") {
              				payments = supportedPayment[payTag] + "<img id='positiveIcon' alt='Ja' src='positive.svg' />";
              			} else {
              				payments = "<br/>" + supportedPayment[payTag] + "<img id='positiveIcon' alt='Ja' src='positive.svg' />";
              			}
              		}
              	}
              }
              ...
              if (description != "") {
              	if (160 >= description.length) {
              		popupContent += "<details open><summary>Beschreibung</summary>" + description + "</details>";
              	} else {
              		popupContent += "<details><summary>Beschreibung</summary>" + description + "</details>";
              	}
              }
              ...
              // Add payment methods to POI details view
              if (payments != "") {
              	popupContent += "<details><summary>Bezahlmöglichkeiten</summary>" + payments + "</details>";
              }
