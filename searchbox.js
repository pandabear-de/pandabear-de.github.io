...
var saved_lat = 50.23304202656137; 
var saved_lon = 8.766059875488283;
var maxSouth = 0;
var maxWest = 0;
var maxNorth = 0;
var maxEast = 0;
	...
	if(searchword.length > 3) {
		$.getJSON("https://photon.komoot.de/api/", {
			...
			$.each(data.features, function(number, feature) {
				...
				autocomplete_content += "<ul onclick='jumpto(" + latlng[0] + ", " + latlng[1] + ", \"" + feature.properties.name + "\")'>" + feature.properties.name + ", " + feature.properties.country + "</ul>";
			});
